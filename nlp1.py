# pip install konlpy   -> 설치 경로

from konlpy.tag import Okt, Kkma, Komoran  # 자주 쓰이는 class 3개
...
print('품사 태깅(어간 포함) : ', okt.pos(text, stem=True))  # 원형(어근)으로 출력이 됨    ex) 그래요 -> 그렇다 
...
text2 = "나는 오늘 아침에 강남에 갔다. 가는 길에 강남에 빵집이 보여 너무 먹고 싶었다. 빵이 특히 강남에 있는 침이 질질질"
