# 앙상블 기법 중 부스팅 : 하나의 모델을 만들어 그 결과로 다른 모델을 만들어 나가는데 샘플 데이터의 일부를 갱신하며 순차적으로 좀 더 강건한 모델을 생성하는 방법 
...
from lightgbm import LGBMClassifier     # xgboost보다 성능이 우수하나 데이터 양이 적으면 과적합 발생(효과 미미)
...
xgb_clf = xgb.XGBClassifier(
    booster = 'gbtree',      # gbtree : DecisionTree, gblinear : DecisionTree 사용하지X
    max_depth = 6, 
    n_estimators = 500, 
